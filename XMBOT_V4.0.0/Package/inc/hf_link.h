...
enum Command
{
    SHAKING_HANDS,     		SET_ROBOT_SPEED,		READ_ROBOT_SPEED,   READ_GLOBAL_COORDINATE,
    READ_ROBOT_COORDINATE,	CLEAR_COORDINATE_DATA,	SET_CLAW,			SET_ARM_TOTAL,
	READ_ARM_TOTAL,		    PLAT_MOVE,    			READ_PLAT,			SET_WRIST,	
	READ_WRIST,				LAST_COMMAND_FLAG		
};
